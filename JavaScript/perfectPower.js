/* DIRECTIONS:
	...
	as an integer power of another positive integer. More formally, n is a perfect power
	...
	(3,4) and (9,2) are valid solutions. However, the tests take care of this, so if a number
	is a perfect power, return any pair that proves it.
 ...
 * @return {Array}    [m, k], mk=n as proof or null
 */
function isPP(n) {
	for (let m = 1; m < n; m++) {
